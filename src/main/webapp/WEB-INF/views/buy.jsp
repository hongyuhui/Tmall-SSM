...
<body>
	...
	<div class="buyPageDiv">
		...
		<form action="front/createOrder" method='POST'>
			<div class="address">
					...
					<thead>
						<tr>
							<th class="productListTableFirstColumn" colspan="2">
								...
								<a href="front/home" class="marketLink">店铺：天猫店铺</a>
						...
						<c:forEach items='${orderitems }' var='oi' varStatus="st">
							<tr class="orderItemTR">
								<td class="orderItemFirstTD">
									<img width="20px" src="img/productSingle/${oi.product.firstProductImage.id }.jpg" class="orderItemImg">
								</td>
								<td class="orderItemProductInfo">
									<a class="orderItemProductLink" href="front/product?id=${oi.product.id }"> ${oi.product.name} </a>
								...
								<td>
									<span class="orderItemProductPrice">
										￥
										<fmt:formatNumber value="${oi.product.promoteprice }" type="number" minFractionDigits="2"></fmt:formatNumber>
									</span>
								</td>
								<td>
								...
								<td>
									<span class="orderItemUnitSum">
										￥
										<fmt:formatNumber value="${oi.number*oi.product.promoteprice}" type="number" minFractionDigits="2"></fmt:formatNumber>
									</span>
								</td>
